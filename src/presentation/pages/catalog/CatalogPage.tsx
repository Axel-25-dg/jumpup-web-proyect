...
export default function CatalogPage() {
  ...
  // Centralizar carga de productos: solo este efecto debe disparar fetchProducts
  useEffect(() => {
    fetchProducts()
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl font-black tracking-tighter text-foreground leading-[1.1]">
              Explora Nuestro <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-indigo-500 to-primary bg-[length:200%_auto] animate-gradient">Catálogo Premium</span>
            </h1>
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto">
             <div className="relative group">
                ...
                <Input
                   ...
                   className="pl-12 h-14 w-full md:w-[400px] bg-card/50 backdrop-blur-sm border-border/50 rounded-2xl font-bold focus:ring-primary/20 focus:border-primary transition-all shadow-sm"
                />
             </div>
        ...
        <main className="lg:col-span-9">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-32 bg-card/20 rounded-[3rem] border-2 border-dashed border-border/50">
              ...
              <Button variant="link" onClick={() => window.location.reload()} className="mt-4 font-bold text-primary">
